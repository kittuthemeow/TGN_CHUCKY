...
from ADDN.edit_2 import (  # pylint:disable=import-error
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from ADDN.edit_3 import (  # pylint:disable=import-error
    black_border,
    blue_border,
    green_border,
    red_border,
)
from ADDN.edit_4 import (  # pylint:disable=import-error
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from ADDN.edit_5 import (  # pylint:disable=import-error
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
...
from ADDN.chuky import chuky as Client
...
async def photo(client: Client, message: Message):
    try:
        if not message.reply_to_message.photo:
            await message.reply_text("Adei paithyam image ku reply panu 🤦 ", quote=True)
            return
    except:
        return
    global lel
