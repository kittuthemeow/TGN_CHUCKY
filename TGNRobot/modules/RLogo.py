...
from TGNRobot.events import register as chuky
...
async def lego(event):
 ...
 try:
    ...
    fname = "chuky.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"BABY  🍼 UN LOGO REAFY ENAKU APADIYE KONJAM DONATE PANU🙈")         
    await pesan.delete()
