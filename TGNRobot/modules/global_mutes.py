...
import TGNRobot.modules.sql.global_mutes_sql as sql
from TGNRobot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GMUTE
...
from TGNRobot.modules.helper_funcs.misc import send_to_list
